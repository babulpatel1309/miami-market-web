...
import { soupSizes } from "@/constants/menu";
import { MENU_PDF_URL } from "@/constants/site";

const sideChips = soupSizes.map((s, i) =>
  i === 0 ? `Sides · ${s}` : s
);

export default function HotPlate() {
  return (
    <section
      id="hotplate"
